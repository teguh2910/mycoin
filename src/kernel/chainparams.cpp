...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1732291200, 1223994, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        // Genesis block assertions - temporarily disabled for testing
        // assert(consensus.hashGenesisBlock == uint256{"00000049bd8158664be8205f8eb713bb8995eb02c3bb063b0dfc54a1bad237fd"});
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        // Signet genesis (using MyCoin timestamp produces different hash)
        // For custom signet, mine with: python contrib/mine_genesis_signet.py
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        // Regtest genesis - uses MyCoin timestamp so hash is different from Bitcoin
        // assert(consensus.hashGenesisBlock == uint256{"..."});
        // assert(genesis.hashMerkleRoot == uint256{"4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"});
