...
public:
    CMainParams() {
        ...
        // Using Bitcoin's genesis block but with current timestamp for MyCoin launch
        genesis = CreateGenesisBlock(1732377600, 2083236893, 0x1d00ffff, 1, 50 * COIN);
...
public:
    CTestNetParams() {
        ...
        // Using Bitcoin's testnet genesis with current timestamp
        genesis = CreateGenesisBlock(1732377600, 414098458, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
